...
public class ResultAdapter extends ArrayAdapter<CarrinhoItem> implements View.OnClickListener{
    ...
    public ResultAdapter(ArrayList<CarrinhoItem> data, Context context) {
...
//                        .setAction("No action", null).show();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.txtType.setText(String.format("R$ %.2f", dataModel.getProd().getValor()));
